   ...
   <div class="container">
      <div class="row no-gutters slider-text align-items-end">
         <div class="col-md-9 ftco-animate pb-5">
            <p class="breadcrumbs mb-2"><span class="mr-2"><a href="<?php echo site_url(); ?>"><?php the_title(); ?> <i class="ion-ios-arrow-forward"></i></a></span> <span>Contact Us <i class="ion-ios-arrow-forward"></i></span></p>
                     ...
                     <div class="info-wrap bg-primary w-100 p-md-5 p-4">
                        ...
                        ?>
                           <div class="dbox w-100 d-flex align-items-center">
                              ...
                              <div class="text pl-3">
                                 <p><span><?php echo $contact['title'];?></span> <a href="<?php echo $contact['contact_url'];?>"><?php echo $contact['description'];?></a></p>
                              </div>
                           </div>
                        <?php
                        }
